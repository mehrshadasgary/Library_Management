...
def game():
    ...
    def rule():
        ...
        elif (results[3] == results[4] == results[5]
              and results[3] != ""):
            show_winner(3)
        elif (results[6] == results[7] == results[8]
              and results[6] != ""):
            show_winner(6)
        elif (results[0] == results[3] == results[6]
              and results[0] != ""):
            show_winner(0)
        elif (results[1] == results[4] == results[7]
              and results[1] != ""):
            show_winner(1)
        elif (results[2] == results[5] == results[8]
              and results[2] != ""):
            show_winner(2)
        elif (results[0] == results[4] == results[8]
              and results[0] != ""):
            show_winner(0)
        elif (results[2] == results[4] == results[6]
              and results[2] != ""):
            show_winner(2)
        else:
            check_draw()
    ...
    def points():
        ...
        label_player_one = tk.Label(board_frame, text="بازیکن 1",
                                    font=("Aviny", 16), padx=10)
        label_player_two = tk.Label(board_frame, text="بازیکن 2",
                                    font=("Aviny", 16), padx=10)
        ...
        point_player_one = tk.Label(point_frame, text=player_points[0],
                                    padx=20, font=("Lalezar", 18))
        point_player_two = tk.Label(point_frame, text=player_points[1],
                                    padx=20, font=("Lalezar", 18))
        ...
        for row in range(1, 4):
            for column in range(1, 4):
                ...
                buttons[index] = tk.Button(board_frame,
                                           command=lambda x=f"{index}": clicked(x))
